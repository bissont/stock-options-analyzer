...
<template>
  <div class="container">
    <h1>Tim's Options Analyzer - v{{ commitCount }}</h1>
    ...
    <section v-if="rfAnalysis" class="card rf-analysis">
      ...
      <div class="rf-stats">
        ...
        <div><strong>Strategy:</strong> 6 nearest expirations, 15 closest OTM strikes each ({{ rfAnalysis.dteRange?.min }}-{{ rfAnalysis.dteRange?.max }} optimal)</div>
